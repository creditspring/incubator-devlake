...
type BasecampDocument struct {
	common.NoPKModel `json:"-" mapstructure:"-"`
	ConnectionId     uint64     `json:"connectionId" gorm:"primaryKey"`
	DocumentId       string     `json:"documentId" gorm:"primaryKey;type:varchar(255)"`
	ProjectId        string     `json:"projectId" gorm:"type:varchar(255);index"`
	VaultId          string     `json:"vaultId" gorm:"type:varchar(255);index"`
	Title            string     `json:"title" gorm:"type:varchar(1000)"`
...
func (BasecampDocument) TableName() string {
