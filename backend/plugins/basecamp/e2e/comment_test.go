...
func TestCommentDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable(
		"./raw_tables/_raw_basecamp_comments.csv",
		"_raw_basecamp_comments",
	)

	// Test extraction
	dataflowTester.FlushTabler(&models.BasecampTodoComment{})
	dataflowTester.Subtask(tasks.ExtractCommentsMeta, taskData)
	dataflowTester.VerifyTableWithOptions(
		models.BasecampTodoComment{},
		e2ehelper.TableOptions{
			CSVRelPath:  "./snapshot_tables/_tool_basecamp_todo_comments.csv",
