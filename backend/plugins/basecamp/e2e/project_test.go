...
func TestProjectDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable(
		"./raw_tables/_raw_basecamp_projects.csv",
		"_raw_basecamp_projects",
	)

	// Test extraction
	dataflowTester.FlushTabler(&models.BasecampProject{})
	dataflowTester.Subtask(tasks.ExtractProjectsMeta, taskData)
	dataflowTester.VerifyTableWithOptions(
		models.BasecampProject{},
		e2ehelper.TableOptions{
			CSVRelPath:  "./snapshot_tables/_tool_basecamp_projects.csv",
			IgnoreTypes: []interface{}{common.NoPKModel{}},
		},
	)
}

func TestProjectWithMultipleTodosetsDataFlow(t *testing.T) {
	var plugin impl.Basecamp
	dataflowTester := e2ehelper.NewDataFlowTester(t, "basecamp", plugin)
	...
	// Import raw API response data with multiple todosets
	dataflowTester.ImportCsvIntoRawTable(
		"./raw_tables/_raw_basecamp_projects_multi_todosets.csv",
		"_raw_basecamp_projects",
	)
	...
	dataflowTester.VerifyTableWithOptions(
		models.BasecampProject{},
		e2ehelper.TableOptions{
			CSVRelPath:  "./snapshot_tables/_tool_basecamp_projects_multi_todosets.csv",
			IgnoreTypes: []interface{}{common.NoPKModel{}},
		},
	)
}
