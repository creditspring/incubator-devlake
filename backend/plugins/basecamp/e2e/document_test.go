...
func TestDocumentDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable(
		"./raw_tables/_raw_basecamp_documents.csv",
		"_raw_basecamp_documents",
	)

	dataflowTester.FlushTabler(&models.BasecampDocument{})
	dataflowTester.Subtask(tasks.ExtractDocumentsMeta, taskData)
	dataflowTester.VerifyTableWithOptions(
		models.BasecampDocument{},
		e2ehelper.TableOptions{
			CSVRelPath:  "./snapshot_tables/_tool_basecamp_documents.csv",
