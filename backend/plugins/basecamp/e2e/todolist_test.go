...
func TestTodolistDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable(
		"./raw_tables/_raw_basecamp_todolists.csv",
		"_raw_basecamp_todolists",
	)

	// Test extraction
	dataflowTester.FlushTabler(&models.BasecampTodolist{})
	dataflowTester.Subtask(tasks.ExtractTodolistsMeta, taskData)
	dataflowTester.VerifyTableWithOptions(
		models.BasecampTodolist{},
		e2ehelper.TableOptions{
			CSVRelPath:  "./snapshot_tables/_tool_basecamp_todolists.csv",
