...
func TestEventDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable(
		"./raw_tables/_raw_basecamp_events.csv",
		"_raw_basecamp_events",
	)

	// Test extraction
	dataflowTester.FlushTabler(&models.BasecampTodoEvent{})
	dataflowTester.Subtask(tasks.ExtractEventsMeta, taskData)
	dataflowTester.VerifyTableWithOptions(
		models.BasecampTodoEvent{},
		e2ehelper.TableOptions{
			CSVRelPath:  "./snapshot_tables/_tool_basecamp_todo_events.csv",
